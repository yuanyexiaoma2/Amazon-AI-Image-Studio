...
export const MODEL_KEY_ZH: Record<string, string> = {
  ...
  'kie-nano-banana-2': 'Nano Banana 2（谷歌）',
  'kie-nano-banana-2-lite': 'Nano Banana 2 Lite（谷歌·快速）',
  'kie-gpt-image-2-5-flare-generate': 'GPT Image 2.5 Flare（文生图）',
  'kie-gpt-image-2-5-flare-edit': 'GPT Image 2.5 Flare（图片编辑）',
  'kie-gpt-image-2-5-sunburst-generate': 'GPT Image 2.5 Sunburst（文生图·精细）',
  'kie-gpt-image-2-5-sunburst-edit': 'GPT Image 2.5 Sunburst（图片编辑·精细）',
