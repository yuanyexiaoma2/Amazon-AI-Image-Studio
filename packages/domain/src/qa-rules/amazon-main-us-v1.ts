import type { MarketRulePack } from '../qa-rule-pack.js';

/** Versioned amazon-main-us-v1 pack (spec §31.15). Source of runtime thresholds. */
export const AMAZON_MAIN_US_V1: MarketRulePack = {
  ...
  rules: [
    ...
    },
    {
      ...
      severity: 'HIGH',
      nonWaivable: false,
      params: { minimumEdgeMarginRatio: 0.01, hardDecisionMaskConfidence: 0.9 },
    },
    {
    ...
    },
    {
      ...
      severity: 'HIGH',
      nonWaivable: false,
      params: { visionReviewBelowConfidence: 0.9 },
    },
    {
    ...
    },
    {
      ...
      evaluator: 'ocr.factMatch.v1',
      type: 'OCR',
      severity: 'HIGH',
      nonWaivable: false,
      params: { keys: ['brand', 'model', 'sku', 'capacity'], failConfidence: 0.9 },
    },
  ],
  sourceUrls: [
